...
import { FaAtlassian, FaMoon } from "react-icons/fa";
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 dark:text-pink-500">
      <nav
      ...
      >
        <div className="px-6 w-full flex flex-wrap items-center justify-between">
          <div className="grow flex flex-row justify-between items-center p-2">
            ...
            >
              <FaAtlassian className="cursor-pointer" size={25} />
            ...
            <div className="flex flex-row justify-center items-center space-x-5">
              ...
              {connectedAccount ? (
                <button
                  ...
                  rounded-full shadow-md hover:bg-pink-700 hover:shadow-lg
                  focus:bg-pink-700 focus:shadow-lg focus:outline-none
                  focus:ring-0 active:bg-pink-800 active:shadow-lg
                  transition duration-150 ease-in-out dark:text-pink-500
